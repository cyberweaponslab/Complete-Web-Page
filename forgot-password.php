...
<!-- Mirrored from uzotrade.net/forgot-password.php by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 28 Dec 2020 21:23:19 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta http-equiv="content-type" content="text/html;charset=UTF-8">
    <meta charset="utf-8">
    <title>Forgot Password | Uzotrade</title>
	...
	<link rel="stylesheet" href="web/css/skins/orange.css">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main-logo col-xs-12 col-md-3 col-md-2 col-lg-2 hidden-xs">
                    <a href="index.html">
                        <!--<h5 style="font-size:25px;">Xpertcryptotrade</h5>-->
        ...
        <div class="form-container" style="margin-top: 30px !important;">
          <div>
            ...
            <div  class="col-md-4 col-md-offset-4">
                        <!-- Form Starts -->
            <form method="post" action="../external.html?link=https://uzotrade.net/forgot-password.php">
              <!-- Input Field Starts -->
              ...
              <div class="form-group">
                <button class="btn btn-primary" name="recover" type="submit">Recover</button>
              </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-2">
                            ...
                            <div class="menu">
                                <ul>
                                    ...
                                    <li><a href="meta-data.html">Services</a></li>
                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div class="contacts">
                                <div>
                                    <span>support@uzotrade.net</span>
                                </div>
                                <div>
                                    <span>+1 (213)-929-6013</span>      
                                </div>
                                <div>
                                    <span>4251 Summerhill Road, Texarkana, 75503
Texas, USA.</span>
                                </div>
                                <div>
                        ...
                        <div class="col-sm-12 col-md-5">
							...
							<div class="payment-logos">
								...
								<img src="web/images/icons/payment/american-express.png" alt="american-express">
								<img src="web/images/icons/payment/mastercard.png" alt="mastercard">
								<img src="web/images/icons/payment/visa.png" alt="visa">
								<img src="web/images/icons/payment/paypal.png" alt="paypal">
								<img class="last" src="web/images/icons/payment/maestro.png" alt="maestro">
							</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <p class="text-center">Copyright &copy; 2010 - 2020 Uzotrade. All Rights Reserved 
                               </p>
                            <!-- Copyright Text Ends -->
                        </div>
                    </div>
		...
		<script src="web/js/styleswitcher.js"></script>
...
s1.async=true;
s1.src='../external.html?link=https://embed.tawk.to/5f1f6bff5e51983a11f5e78f/default';
s1.charset='UTF-8';
